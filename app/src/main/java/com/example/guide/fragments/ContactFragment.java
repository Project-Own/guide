...
public class ContactFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        contacts.add(new Contact("Embassy of the People's Republic of China","01-4440286","cny"));
        ...
        contacts.add(new Contact("Embassy of the Democratic People's Republic of Korea","01- 5521855/01-5535871","dpr"));
        ...
        contacts.add(new Contact("Embassy of the Republic of Korea","01-4270172/01-4270417","skr"));
        ...
        contacts.add(new Contact("Embassy the United States of America","01-4234000","usdd"));

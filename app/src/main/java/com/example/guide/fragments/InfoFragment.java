...
public class InfoFragment extends Fragment {
    ...
    String ticketInfo = "This ticket covers all of Bhaktapur including, Bhaktapur Durbar Square, Pottery Square, Taumadhi Square and Dattatreya Tole. Ticket can be extended for one week with no extra cost if you are planning to stay in Bhaktapur.\n\nTicket booths are located at all the main entrance streets into the old city of Bhaktapur and there are random \"ticket inspections\" so do hold on to your ticket! \n" +
            "\n";
    String aboutAbstract = "Bhaktapur, known as Khwopa in local Nepal bhasa is the eastern gateway of the Kathmandu valley which lies about 16 kilometers from the heart of Kathmandu city. Bhaktapur is a medieval town locked in centuries–old beliefs and trad" +
            "itions.";
    String price = "SAARC COUNTRIES : 200$ \nOTHER COUNTRIES: 400";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        linearInfo = v.findViewById(R.id.linearInfo);


        abstractTextView.setText(aboutAbstract);
        ticketTextView.setText(price);

...
import static com.example.guide.Modal.GlobalVars.BASE_REQ_URL;
import static com.example.guide.Modal.GlobalVars.DEFAULT_LANG_POS;
import static com.example.guide.Modal.GlobalVars.LANGUAGE_CODES;
...
import com.example.guide.Modal.QueryUtils;
    ...
    private class TranslateText extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... input) {
            ...
            uriBuilder.appendPath("translate")
                    .appendQueryParameter("key", getString(R.string.translator_api_key))

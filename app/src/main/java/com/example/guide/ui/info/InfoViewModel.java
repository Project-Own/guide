...
public class InfoViewModel extends AndroidViewModel {
    ...
    private void setInfoData() {
        String infoText = "Bhaktapur, known as Khwopa in local Nepal bhasa is the eastern gateway of the Kathmandu valley which lies about 16 kilometers from the heart of Kathmandu city. Bhaktapur is a medieval town locked in centuries–old beliefs and trad" +
        ...
        String infoTicketData = "This ticket covers all of Bhaktapur including, Bhaktapur Durbar Square, Pottery Square, Taumadhi Square and Dattatreya Tole. Ticket can be extended for one week with no extra cost if you are planning to stay in Bhaktapur.\n\nTicket booths are located at all the main entrance streets into the old city of Bhaktapur and there are random \"ticket inspections\" so do hold on to your ticket! \n" +
                "\n";

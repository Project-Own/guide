...
public class ContactViewModel extends AndroidViewModel {
    ...
    private void loadEmmergencyContactsList() {
        contacts.clear();
        contacts.add(new Contact("Police Control", "+977-100", "police1",""));
        contacts.add(new Contact("Emergency Ambulance", "+977-102", "ambulance",""));
        contacts.add(new Contact("Tourist Police", "+977-1144(Toll Free/ Hotline)", "police1","Head Quarter-> Bhrikuti Mandap, Kathmandu"));
        ...
        contacts.add(new Contact("Nepal Tourism Board", "01-4256909/01-4256229", "ntb","Bhrikuti Mandap, Kathmandu"));
        ...
        contacts.add(new Contact("International Flight Service", "01-4470311/01-4472835(ext )", "aero","Kathmandu"));
